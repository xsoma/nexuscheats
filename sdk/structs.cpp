...
AnimationLayer* player_t::get_animlayer(int i)
{
	if (i < 15)
		return &get_animlayers()[i];
	return nullptr;
}
...
void IClientLeafSystem::CreateRenderableHandle(void* obj)
{
	...
	get_method<tOriginal>(this, 0)(this, reinterpret_cast<uintptr_t>(obj) + 0x4, 0, 0, 0xFFFFFFFF, 0xFFFFFFFF);
}