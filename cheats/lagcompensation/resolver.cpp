...
bool ValidPitch(player_t* entity)
{
	...
	return pitch == 0 || pitch > 85 || pitch < -85;
}
...
{
	if (!g_cfg.ragebot.pitch_antiaim_correction || key_binds::get().get_key_bind_state(28))
		return;
...
float resolver::resolve_pitch()
{
	...
	return pitch > 89 ? 89 : pitch < -89 ? -89 : original_pitch;
}